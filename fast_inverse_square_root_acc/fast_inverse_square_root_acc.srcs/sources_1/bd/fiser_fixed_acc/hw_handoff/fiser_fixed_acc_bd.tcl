...
################################################################
# This is a generated script based on design: fiser_fixed_acc
#
...
# source fiser_fixed_acc_script.tcl
...
set design_name fiser_fixed_acc
...
proc create_root_design { parentCell } {
  ...
  # Create instance: fisr_fixed_ip_0, and set properties
  set fisr_fixed_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:fisr_fixed_ip:1.0 fisr_fixed_ip_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {25.00000} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins fisr_fixed_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins fisr_fixed_ip_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins fisr_fixed_ip_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fisr_fixed_ip_0/S00_AXI/S00_AXI_reg] SEG_fisr_fixed_ip_0_S00_AXI_reg
